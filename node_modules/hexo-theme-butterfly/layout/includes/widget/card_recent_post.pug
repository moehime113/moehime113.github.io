  ...
  .card-widget.card-recent-post
    .item-headline
      a.faa-parent.animated-hover
        svg.faa-tada.icon(style="height:25px;width:25px;fill:currentColor;position:relative;top:5px;margin-right:5px" aria-hidden="true")
          use(xlink:href='#icon-zuixinwenzhang')
